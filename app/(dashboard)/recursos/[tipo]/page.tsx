...
export default function RecursoPage() {
    ...
    try {
      ...
      switch (tipo) {
        ...
        case "suscripcion":
          ...
          response = await api.getSuscripciones();
    ...
    try {
      ...
      switch (tipo) {
        ...
        case "suscripcion":
          ...
          await api.eliminarSuscripcion(itemToDelete.id);
      ...
      if (selectedItem?.id) {
        ...
        switch (tipo) {
          ...
          case "suscripcion":
            ...
            await api.actualizarSuscripcion(selectedItem.id, data);
        ...
        switch (tipo) {
          ...
          case "suscripcion":
            ...
            await api.crearSuscripcion(data);
  ...
  const tituloMap: Record<RecursoTipo, string> = {
    ...
    suscripcion: "Suscripcione", //dejar como Suscripcione

  };



  const titulo = tituloMap[tipo] || tipo.charAt(0).toUpperCase() + tipo.slice(1);
